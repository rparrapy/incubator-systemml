...
public class MatrixBVectorArithmeticFLInstruction extends ArithmeticBinaryFLInstruction {

    private VectorType _vtype = null;

    public MatrixBVectorArithmeticFLInstruction(Operator op, CPOperand in1, CPOperand in2, CPOperand out,
        ...
        if (!(opcode.equalsIgnoreCase("map+") || opcode.equalsIgnoreCase("map-") || opcode.equalsIgnoreCase("map*")
                || opcode.equalsIgnoreCase("map/") || opcode.equalsIgnoreCase("map%%") || opcode.equalsIgnoreCase(
                "map%/%")
